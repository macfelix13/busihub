...
export default async function BusinessSettingsPage() {
  ...
  // seeded role's permission set â€” supabase/migrations/0011). Cosmetic â€”
  ...
  if (!business) {
    // Shouldn't happen â€” every business row from register_business() has
    // one â€” but the (app) layout only guarantees a profile exists, not
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <p className="mt-4 text-sm text-neutral-500">
          ...
          changed here â€” every price and tax calculation in Busihub assumes they stay fixed.
        </p>
      </div>
