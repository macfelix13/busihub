...
export function BarcodeSection() {
  return (
    <section id="barcode" className="border-t border-neutral-200 bg-canvas dark:border-surface-line dark:bg-surface/40">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-6 sm:py-24">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 dark:border-surface-line dark:bg-surface-card">
            ...
            <h3 className="mt-4 text-base font-semibold text-neutral-900 dark:text-ink">Barcode scanner</h3>
            <p className="mt-1.5 text-sm text-neutral-500 dark:text-ink-muted">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6 dark:border-surface-line dark:bg-surface-card">
            ...
            <h3 className="mt-4 text-base font-semibold text-neutral-900 dark:text-ink">Phone camera</h3>
            <p className="mt-1.5 text-sm text-neutral-500 dark:text-ink-muted">
        ...
        <div className="mx-auto mt-10 flex max-w-3xl flex-wrap items-center justify-center gap-x-1 gap-y-6">
          {FLOW.map((Icon, i) => (
            <div key={FLOW_LABELS[i]} className="flex items-center gap-1">
              ...
              {i < FLOW.length - 1 ? <ArrowRight className="h-4 w-4 shrink-0 text-neutral-300 dark:text-ink-muted" /> : null}
            </div>
          ))}
        </div>
      </div>
